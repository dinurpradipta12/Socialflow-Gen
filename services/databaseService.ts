...
export const databaseService = {
  ...
  /**
   * Mendapatkan SQL Schema untuk setup awal (Update V2)
   */
  getSchemaSQL: () => {
    return `
...
-- TABLE 2: REGISTRATIONS (Untuk Penampungan Pendaftaran Publik)
-- Aplikasi Monitoring akan membaca tabel ini. Ubah status jadi 'approved' di App Monitoring.
